...
Erzeugt von neues-portal.py aus dem Themenprofil `themen/diabetes.json`.
...
_THEMA = (
    '((("Diabetes Mellitus"[Majr] OR "Diabetes Mellitus, Type 2"[Majr] OR '
    '"Diabetes Mellitus, Type 1"[Majr] OR "Diabetes, Gestational"[Majr] '
    'OR "Diabetes Complications"[Majr] OR "Diabetic Retinopathy"[Majr] OR '
    '"Diabetic Nephropathies"[Majr] OR "Diabetic Neuropathies"[Majr] OR '
    '"Diabetic Foot"[Majr] OR "Diabetic Angiopathies"[Majr] OR "Diabetic '
    'Ketoacidosis"[Majr] OR "Prediabetic State"[Majr] OR "Blood Glucose '
    'Self-Monitoring"[Majr] OR "Insulin Infusion Systems"[Majr] OR '
    '"Insulin"[Majr] OR "Hypoglycemic Agents"[Majr] OR "Sodium-Glucose '
    'Transporter 2 Inhibitors"[Majr] OR "Glucagon-Like Peptide-1 Receptor '
    'Agonists"[Majr] OR "Islets of Langerhans"[Majr] OR "Insulin '
    'Resistance"[Majr] OR diabetes[Title] OR diabetic[Title] OR '
    'prediabet*[Title] OR HbA1c[Title] OR "blood glucose"[Title] OR '
    'glycaemic[Title] OR glycemic[Title] OR insulin[Title] OR "continuous '
    'glucose"[Title] OR "closed-loop"[Title] OR semaglutide[Title] OR '
    'tirzepatide[Title] OR SGLT2[Title] OR metformin[Title])) NOT '
    '(("Obesity"[Majr] OR "Obesity, Morbid"[Majr] OR "Pediatric '
    'Obesity"[Majr] OR "Overweight"[Majr] OR "Weight Loss"[Majr] OR '
    '"Weight Gain"[Majr] OR "Bariatric Surgery"[Majr] OR '
    '"Bariatrics"[Majr] OR "Weight Reduction Programs"[Majr] OR '
    '"Anti-Obesity Agents"[Majr] OR "Body Mass Index"[Majr] OR '
    '"Adiposity"[Majr] OR "Metabolic Syndrome"[Majr] OR bariatric[Title] '
    'OR "weight loss"[Title] OR "weight management"[Title] OR "metabolic '
    'syndrome"[Title]) OR ("Artificial Intelligence"[Majr] OR "Machine '
    'Learning"[Majr] OR "Deep Learning"[Majr] OR "Telemedicine"[Majr] OR '
    '"Medical Informatics"[Majr] OR "Nursing"[Majr] OR "Nursing '
    'Care"[Majr] OR "Long-Term Care"[Majr] OR "Nursing Homes"[Majr] OR '
    '"Aging"[Majr] OR "Longevity"[Majr] OR "Frailty"[Majr] OR '
    '"Geriatrics"[Majr] OR "Health Literacy"[Majr] OR "Patient Education '
    'as Topic"[Majr] OR "Climate Change"[Majr] OR "Air Pollution"[Majr] '
    'OR "Vaccination"[Majr] OR "Vaccines"[Majr] OR "Multimorbidity"[Majr] '
    'OR "Patient Safety"[Majr] OR "Medical Errors"[Majr] OR "Cross '
    'Infection"[Majr] OR "Mental Health Services"[Majr])))'
)
_KONTEXT = (
    '("Diabetes Care"[Journal] OR "Diabetologia"[Journal] OR "Lancet '
    'Diabetes Endocrinol"[Journal] OR "Diabetes"[Journal] OR "Diabet '
    'Med"[Journal] OR "Diabetes Obes Metab"[Journal] OR "J Clin '
    'Endocrinol Metab"[Journal] OR "Cardiovasc Diabetol"[Journal] OR '
    '"Diabetes Technol Ther"[Journal] OR "Nat Rev Endocrinol"[Journal] OR '
    '"BMJ Open Diabetes Res Care"[Journal] OR "Exp Clin Endocrinol '
    'Diabetes"[Journal] OR "Diabetes Res Clin Pract"[Journal] OR "Acta '
    'Diabetol"[Journal] OR "Diabetes Metab"[Journal] OR "J Diabetes '
    'Complications"[Journal] OR "Prim Care Diabetes"[Journal] OR "J '
    'Diabetes Investig"[Journal] OR "Diabetes Metab Res Rev"[Journal] OR '
    '"J Diabetes Sci Technol"[Journal] OR "Eur J Endocrinol"[Journal] OR '
    '"Endocrine"[Journal] OR "Clin Diabetes"[Journal] OR "Diabetes '
    'Spectr"[Journal] OR "Diabetol Metab Syndr"[Journal] OR "Nutr '
    'Diabetes"[Journal] OR "Diabetes Ther"[Journal] OR "N Engl J '
    'Med"[Journal] OR "Lancet"[Journal] OR "JAMA"[Journal] OR '
    '"BMJ"[Journal] OR "Nat Med"[Journal] OR "Nature"[Journal] OR '
    '"Science"[Journal] OR "Ann Intern Med"[Journal] OR "Dtsch Arztebl '
    'Int"[Journal])'
)
...
# ------------------------------------------------------------------- Prompts
SYSTEM = (
    "Du bist Fachredakteur fuer Diabetologie. "
    ...
    "diabetologische Schwerpunktpraxen, Kliniken, Hausarztpraxen, Kostentraeger, Selbstverwaltung und Gesundheitspolitik. "
...
Waehle GENAU 6 Studien aus, die (a) Diagnostik, Therapie, Folgeerkrankungen, Technik oder Versorgung bei Diabetes betreffen - oder die Grundlagen, auf denen sie beruhen UND (b) im
...
HARTE REGELN ZUR ZUSAMMENSETZUNG (sie gehen der thematischen Rangfolge vor):
  ...
  4. HOECHSTENS ZWEI der sechs duerfen ausschliesslich einen
     Stoffwechselparameter berichten (HbA1c, Nuechternglukose, Time in
     Range) ohne klinischen Endpunkt. Diese Arbeiten sagen, dass sich eine
     Zahl bewegt, nicht, dass es jemandem besser geht.
  5. HOECHSTENS EINE darf ein Inkretin im Mittelpunkt haben
     (GLP-1-Rezeptoragonisten, Doppel- und Tripelagonisten, Semaglutid,
     Tirzepatid). Diese Substanzklasse gehoert in mehrere Hubs und ist
     hier bewusst NICHT aus der Abfrage ausgeschlossen. Die Teilung:
     glykaemischer Endpunkt im Vordergrund - dann hierher. Geht es um
     Gewichtsreduktion, gehoert die Arbeit nach adipositas.m-vf.de; steht
     ein kardialer Endpunkt im Vordergrund, nach kardio.m-vf.de.
     Glukosemesstechnik und Insulinpumpen sind von Quote 3 NICHT
     betroffen - sie sind Diabetestechnik, nicht Digitalisierung.
...
Besonderheit dieses Themenfeldes: Zwischen Studienlage und Versorgung stehen in Deutschland die Disease-Management-Programme. Was dort nicht vorgesehen ist, findet in der Flaeche kaum statt, so gut die Evidenz auch sein mag. Dazu kommen die Erstattungsfragen: Kontinuierliche Glukosemessung, Insulinpumpen und die neueren Substanzklassen sind Hilfsmittel- und Verordnungsfragen, nicht nur Therapiefragen. Ordne eine Arbeit deshalb immer daran ein, ob und wie ihr Befund hier ankommen kann - und sage es, wenn er das absehbar nicht kann. Nenne bei internationalen Arbeiten das Gesundheitssystem, in dem sie entstanden sind.
...
- title: praegnanter deutscher Titel, **hoechstens 160 Zeichen**. Der
  ...
  **Er MUSS das Ergebnis nennen, nicht nur die Massnahme.** Und er darf
  sich NICHT auf den Laborwert beschraenken: Eine HbA1c-Differenz ist der
  Zwischenschritt, nicht das Ziel. Wo eine Arbeit einen klinischen Endpunkt
  berichtet - Amputation, Dialyse, Erblindung, Herzinfarkt, Sterblichkeit -,
...
Englisch bleiben: HbA1c, Time in Range, Closed Loop, SGLT2, GLP-1, Diabetes Distress. Deutsch: diabetisches Fusssyndrom, Blutzuckerselbstmessung, Schulung, strukturierte Behandlungsprogramme. Beispiele fuer Begriffe, die englisch bleiben: Outcome, Baseline, Setting, Follow-up, Screening, Hazard Ratio, Odds Ratio, Patient-Reported Outcomes, Real-World-Evidenz, Shared Decision Making. Uebersetze dagegen alles, wofuer es einen eingefuehrten deutschen Ausdruck gibt.
