# Diabetes · Rechercheportal

Ein Rechercheportal zum Themenfeld **Diabetes**: 61 Datenbanken in 9 Rubriken,
davon 28 mit Live-Suche, dazu eine täglich aus PubMed kuratierte Studienauswahl mit
deutschen Zusammenfassungen.

Ein Angebot von **Monitor Versorgungsforschung** (eRelation AG – Content in Health, Bonn).

https://diabetes.m-vf.de/
...
dort indexiert sind (83 Begriffe).

| | |
|---|---|
| Datenbanken | 61 in 9 Rubriken |
| Live-Suche | 28 |
| Portal (feste URL) | 28 |
| Lizenz nötig | 5 |
| Suchglossar | 83 Begriffe |
...
Secrets im Repository: `DIABETESHUB` (Claude-API) und `DIABETESHUBMC` (Mailchimp).
